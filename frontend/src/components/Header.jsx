...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-blue-100 rounded-lg px-4 sm:px-6 md:px-10 lg:px-20'>
      ...
      {/* --------- Header Left --------- */}
      <div className='md:w-1/2 flex flex-col items-start justify-start gap-5 py-8 sm:py-10 md:py-16'>
        <p className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-blue-900 font-semibold leading-tight'>
          Book Appointment <br /> With Trusted Doctors
        </p>

        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3 text-blue-800 text-sm font-light max-w-md'>
          <img
            className='w-20 sm:w-24 rounded-full border-2 border-white shadow-lg'
      ...
      <style>
        {`
          @keyframes float {
            ...
            50% { transform: translateY(10px); } /* positive 10px to move down */
          }
          .animate-float {
